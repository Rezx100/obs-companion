...
process.umask(0o077);
require('../src/runtime-config.cjs').config();
if(!process.env.OBS_WEBSOCKET_PASSWORD||process.env.OBS_WEBSOCKET_PASSWORD.length<32)throw Error('OBS_WEBSOCKET_PASSWORD must contain a random token of at least 32 characters');
